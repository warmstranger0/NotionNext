...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一颗韭菜, Hi，我也可以割韭菜,Hi，我或者可以种韭菜,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ameng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '割韭菜', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Ameng, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'grammy1988@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '山雀',
      artist: '万能青年旅店',
      url: 'https://music.163.com/#/song?id=1805289414',
      cover:
          ''
    },
    {
      name: '失眠症候群',
      artist: '大宽',
      url: 'https://music.163.com/#/song?id=520478982',
      cover:
          ''
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '66849591', // 对应歌单的 id
